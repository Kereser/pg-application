package co.com.crediya.application.r2dbc;
...
class ApplicationStatusReactiveRepositoryAdapterTest {
  ...
  //  @InjectMocks ApplicationRepositoryAdapter repositoryAdapter;
  //
  ...
  //
  //    StepVerifier.create(result).expectNextMatches(value ->
  // value.equals("test")).verifyComplete();
  //  }
  //
  //  @Test
