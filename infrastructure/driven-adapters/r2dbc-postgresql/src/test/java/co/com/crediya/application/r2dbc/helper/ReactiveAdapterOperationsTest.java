...
class ReactiveAdapterOperationsTest {
  ...
  //    operations =
  //        new ReactiveAdapterOperations<DummyEntity, DummyData, String, DummyRepository>(
  ...
  //      extends ReactiveCrudRepository<DummyData, String>,
  //          ReactiveQueryByExampleExecutor<DummyData> {}
}
