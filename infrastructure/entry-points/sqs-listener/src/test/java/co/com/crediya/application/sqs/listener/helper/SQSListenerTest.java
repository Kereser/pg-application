...
import co.com.crediya.application.sqs.listener.SQSProcessor;
...
class SQSListenerTest {
  ...
  @Mock private HandleStatusAfterLambdaDebtEvaluationUseCase useCase;
  ...
  void listenerTest() {
    var sqsListener =
        SQSListener.builder()
            ...
            .processor(new SQSProcessor(useCase, objectMapper))
            .operation("operation")
            .build();
